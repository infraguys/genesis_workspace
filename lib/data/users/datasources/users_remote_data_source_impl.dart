...
class UsersRemoteDataSourceImpl implements UsersRemoteDataSource {
  ...
  @override
  Future<ChannelByIdResponseDto> getChannelById(ChannelByIdRequestDto body) async {
    try {
      return await apiClient.getChannelById(body.streamId);
    } catch (e) {
      rethrow;
    }
  }
  ...
  @override
  Future<ChannelMembersResponseDto> getChannelMembers(ChannelMembersRequestDto body) async {
    try {
      return await apiClient.getChannelMembers(body.streamId);
    } catch (e) {
      rethrow;
    }
  }
