...
import 'platform_chunk_reader_io.dart' if (dart.library.html) 'platform_chunk_reader_web.dart' as impl;
...
PlatformChunkReader createPlatformChunkReader(UploadFileRequestDto body) => impl.createPlatformChunkReader(body);
