...
class RealTimeConnection {
  ...
  RealTimeConnection({
    ...
    required UpdateOrganizationEmojiServerUrlUseCase updateOrganizationEmojiServerUrlUseCase,
    ...
    Duration maxRetryDelay = const Duration(seconds: 20),
       ...
       _updateOrganizationEmojiServerUrlUseCase = updateOrganizationEmojiServerUrlUseCase,
  ...
  Future<void> _registerQueue() async {
    try {
      ...
      _serverEmojiDataUrl = registerQueueEntity.serverEmojiDataUrl;

      await Future.wait([
        _updateOrganizationEmojiServerUrlUseCase.call(
          organizationId: organizationId,
          emojiServerUrl: _serverEmojiDataUrl,
        ),
