...
class _UpdateViewState extends State<UpdateView> {
  ...
  Widget build(BuildContext context) {
    ...
    _desktopUpdaterController.localization = DesktopUpdateLocalization(
      ...
      newVersionAvailableText: updateWidgetTexts.newVersionAvailable(version: appVersion),
      newVersionLongText: updateWidgetTexts.newVersionLong(size: downloadSize),
        ...
        return Scaffold(
          body: Column(
            children: [
              ...
              if (appVersion.isEmpty) Center(child: CircularProgressIndicator()),
