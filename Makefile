...
build_app_bundle:
	flutter build appbundle --flavor prod -t lib/prod.dart --dart-define-from-file=env.json
...
.PHONY: generate watch slang clean format format_check build_stage_web build_prod_web build_stage_apk build_prod_apk build_prod_macos build_stage_linux build_prod_linux build_prod_windows ci_stage_web ci_prod_web ci_prod_apk ci_stage_apk ci_stage_linux ci_prod_linux ci_prod_windows rename_prod_apk open_directories generate_app_icons build_app_bundle
